...
type TotalUserResponse struct {
	...
	TotalUser int32 `protobuf:"varint,1,opt,name=total_user,json=totalUser,proto3" json:"total_user,omitempty"`
}

func (x *TotalUserResponse) Reset() {
	*x = TotalUserResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TotalUserResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TotalUserResponse) ProtoMessage() {}

func (x *TotalUserResponse) ProtoReflect() protoreflect.Message {
	mi := &file_user_msg_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TotalUserResponse.ProtoReflect.Descriptor instead.
func (*TotalUserResponse) Descriptor() ([]byte, []int) {
	return file_user_msg_proto_rawDescGZIP(), []int{2}
}

func (x *TotalUserResponse) GetTotalUser() int32 {
	if x != nil {
		return x.TotalUser
	}
	return 0
...
var file_user_msg_proto_rawDesc = []byte{
	...
	0x12, 0x08, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x61, 0x70, 0x70, 0x22, 0x62, 0x0a, 0x04, 0x55, 0x73,
	...
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x6f,
	...
	0x32, 0x0a, 0x11, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x5f, 0x75, 0x73,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x55,
	0x73, 0x65, 0x72, 0x42, 0x3a, 0x0a, 0x14, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x61,
	0x70, 0x70, 0x2e, 0x6d, 0x6f, 0x76, 0x69, 0x65, 0x61, 0x70, 0x70, 0x42, 0x0d, 0x4d, 0x6f, 0x76,
	0x69, 0x65, 0x41, 0x70, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x0b, 0x6d, 0x6f,
	0x76, 0x69, 0x65, 0x61, 0x70, 0x70, 0x2f, 0x70, 0x62, 0xa2, 0x02, 0x03, 0x4d, 0x41, 0x50, 0x62,
...
var file_user_msg_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_user_msg_proto_goTypes = []interface{}{
	(*User)(nil),              // 0: movieapp.User
	(*CreateUserRequest)(nil), // 1: movieapp.CreateUserRequest
	(*TotalUserResponse)(nil), // 2: movieapp.TotalUserResponse
}
...
func file_user_msg_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_user_msg_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TotalUserResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
